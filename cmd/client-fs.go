...
// Get Object Tags
func (f *fsClient) GetObjectTagging() (*tags.Tags, *probe.Error) {
	return &tags.Tags{}, probe.NewError(APINotImplemented{
...
// Set Object tags
func (f *fsClient) SetObjectTagging(t *tags.Tags) *probe.Error {
	return probe.NewError(APINotImplemented{
