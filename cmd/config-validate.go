...
func validateConfigVersion(config *mcConfig) (bool, string) {
...
func validateConfigFile(config *mcConfig) (bool, []string) {
...
func validateConfigHost(host mcHostConfig) (bool, []string) {
	var validationSuccessful = true
