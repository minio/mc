...
func catURL(ctx context.Context, sourceURL string, encKeyDB map[string][]prefixSSEPair, o catOpts) *probe.Error {
	...
	default:
		...
		if client, content, err := url2Stat(ctx, url2StatOptions{urlStr: sourceURL, versionID: o.versionID, fileAttr: false, encKeyDB: encKeyDB, timeRef: o.timeRef, isZip: o.isZip, ignoreBucketExists: false}); err == nil {
			if o.versionID == "" {
