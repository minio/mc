...
func checkDiffSyntax(ctx context.Context, cliCtx *cli.Context, encKeyDB map[string][]prefixSSEPair) {
	...
	_, firstContent, err := url2Stat(ctx, url2StatOptions{firstURL, "", false, encKeyDB, time.Time{}, false, false})
	if err != nil {
	...
	_, secondContent, err := url2Stat(ctx, url2StatOptions{secondURL, "", false, encKeyDB, time.Time{}, false, false})
	if err != nil {
