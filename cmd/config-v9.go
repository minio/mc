...
// AESConfigV9 - config for AES encryption
type AESConfigV9 struct {
	Enable bool   `json:"enable"`
	Key    string `json:"key"`
}

// RSAConfigV9 - config for RSA encryption
type RSAConfigV9 struct {
	Enable     bool   `json:"enable"`
	PublicKey  string `json:"publicKey"`
	PrivateKey string `json:"privateKey"`
}

type encryptionConfigV9 struct {
	AES AESConfigV9 `json:"AES"`
	RSA RSAConfigV9 `json:"RSA"`
}
...
type hostConfigV9 struct {
	...
	API        string             `json:"api"`
	Encryption encryptionConfigV9 `json:"encryption"`
}

// configV9 config version.
...
// saveConfigV9 - saves an updated config.
