...
type sseParameterOverlapErr error

var errSSEParameterOverlap = func(param, overlappingParam string) *probe.Error {
	msg := param + " and " + overlappingParam + " cannot be used together"
	return probe.NewError(sseParameterOverlapErr(errors.New(msg))).Untrace()
}
