...
EXAMPLES:
  ...
  4. Copy an ISO image to an object on minio storage using s3 encryption.
     {{.Prompt}} cat debian-8.2.iso | {{.HelpName}} --enc-s3="minio/opensource-isos=my-key-name" minio/opensource-isos/gnuos.iso
