...
EXAMPLES:
   ...
   2. Sync a bucket recursively from Minio object storage to multiple buckets on Amazon S3 object storage
         $ mc sync http://play.minio.io:9000/photos/2014... https://s3.amazonaws.com/backup-photos https://s3.amazonaws.com/my-photos

   3. Copy a local folder recursively to Minio object storage and Amazon S3 object storage
         $ mc sync backup/... http://play.minio.io:9000/archive https://s3.amazonaws.com/archive
