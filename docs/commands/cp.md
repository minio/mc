...
EXAMPLES:
   ...
   2. Copy a bucket recursively from Minio object storage to Amazon S3 object storage
         $ mc cp http://play.minio.io:9000/photos/burningman2011... https://s3.amazonaws.com/private-photos/burningman/

   3. Copy multiple local folders recursively to Minio object storage
         $ mc cp backup/2014/... backup/2015/... http://play.minio.io:9000/archive/
